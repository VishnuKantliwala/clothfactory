                        ...
                        <form class="form-horizontal" method="post" action="AddCustomer">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" name="txtCustomerFname" autofocus="" required=""/>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" name="txtCustomerLname" required=""/>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" class="form-control" name="txtCustomerCnt1" required=""/>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" class="form-control" name="txtCustomerCnt2" required=""/>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="email" name="txtCustomerEmail" class="form-control" required="">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="txtCustomerAdrs1" class="form-control" required="">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  name="txtCustomerAdrs2" class="form-control" required="">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="txtCustomerCity" class="form-control" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="txtCustomerState" class="form-control" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" name="txtCustomerPincode" class="form-control" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="txtCustomerCountry" class="form-control" required="">
                                    </div>
                                </div>
